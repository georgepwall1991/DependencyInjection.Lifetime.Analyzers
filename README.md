...
```bash
dotnet add package DependencyInjection.Lifetime.Analyzers --version 2.11.10
```

Or add a package reference directly:

```xml
<PackageReference Include="DependencyInjection.Lifetime.Analyzers" Version="2.11.10">
...
```xml
<PackageVersion Include="DependencyInjection.Lifetime.Analyzers" Version="2.11.10" />
```
