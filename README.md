...
```bash
dotnet add package DependencyInjection.Lifetime.Analyzers --version 2.10.11
```

Or add a package reference directly:

```xml
<PackageReference Include="DependencyInjection.Lifetime.Analyzers" Version="2.10.11">
...
```xml
<PackageVersion Include="DependencyInjection.Lifetime.Analyzers" Version="2.10.11" />
```
