...
```bash
dotnet add package DependencyInjection.Lifetime.Analyzers --version 3.5.6
```

Or add a package reference directly:

```xml
<PackageReference Include="DependencyInjection.Lifetime.Analyzers" Version="3.5.6">
...
```xml
<PackageVersion Include="DependencyInjection.Lifetime.Analyzers" Version="3.5.6" />
```
