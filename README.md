...
```bash
dotnet add package DependencyInjection.Lifetime.Analyzers --version 3.5.18
```

Or add a package reference directly:

```xml
<PackageReference Include="DependencyInjection.Lifetime.Analyzers" Version="3.5.18">
...
```xml
<PackageVersion Include="DependencyInjection.Lifetime.Analyzers" Version="3.5.18" />
```
...
1. Reference the package with `PrivateAssets="all"` (version `3.5.18` above).
