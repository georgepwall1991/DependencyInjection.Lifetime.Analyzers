...
**Version:** 2.10.0
**Test result:** 1436/1436 passing (verified this date, 0 skipped).
...
| Metric | Value |
|--------|-------|
| Total tests | 1436 (verified passing 2026-06-10) |
| Analyzer tests | 1113 (per-rule 1092 + cross-rule 10 + keyed 9 + ServiceDescriptor registration 2) |
| Code fix tests | 188 |
...
| DI021 sink/catalog v2 expansion | TPL Dataflow, EventHubs batch sinks (RabbitMQ shipped 2.10.1, PLINQ 2.10.7); scoped-lifetime DI022 tier via RegistrationCollector; instance-correlated chain proofs (same-tree helper methods shipped 2.10.2) | Medium |
