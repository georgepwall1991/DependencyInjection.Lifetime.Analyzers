...
public class DI004_UseAfterDisposeAnalyzerTests
{
    ...
    [Fact]
    public async Task NullForgivingServiceUsedAfterDispose_ReportsDiagnostic()
    {
        var source = Usings + """
    ...
    [Fact]
    public async Task CastServiceUsedAfterDispose_ReportsDiagnostic()
    {
        var source = Usings + """
            public interface IMyService
            {
            ...
            public class MyClass
            {
                ...
                public void ProcessWork()
                {
                    ...
                    var service = scope.ServiceProvider.GetRequiredService<IMyService>();
                    scope.Dispose();
                    {|DI004:((IMyService)service).DoWork()|};
                }
            }
